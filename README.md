...
##### Python3 + OpenCV, Neural Networks, Raspberry Pi, Arduino Uno, Motor Driver, PiCamera, Ultrasonic sensor
...
### For more information and details visit the folder "Multimedia and Sources". Don't stay too far from the presentation "Robotics in India" which explains the project.
